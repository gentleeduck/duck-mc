...
- `criterion` reports throughput in MiB/s; the MB/s column below is the same midpoint converted to decimal MB/s (MB/s = MiB/s × 1.048576).
...
| --- | --- | ---: | ---: | ---: | ---: |
| `dmc_parser::parse` | small (~1 KiB) | 23.199 µs | 23,199 | 49.82 | 52.2 |
...
| `parse + dmc_codegen::render_html` | small (~1 KiB) | 30.156 µs | 30,156 | 38.33 | 40.2 |
...
| --- | --- | ---: | ---: |
| `dmc_parser::parse` | small | 23.075 µs | 52.5 |
| `dmc_parser::parse` | medium | 2.1458 ms | 47.8 |
| `dmc_parser::parse` | large | 160.62 ms | 32.6 |
| `parse + render_html` | small | 30.047 µs | 40.3 |
