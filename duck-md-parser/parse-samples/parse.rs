...
//!
//!     cargo run -p duck-md-parser --bin parse                        # default: ../samples/index.mdx
//!     cargo run -p duck-md-parser --bin parse -- path/to/file.mdx
//!     echo '# hi' | cargo run -p duck-md-parser --bin parse -        # stdin (use `-`)
//!
//! Flags:
