...
//!
//!     cargo run -p duck-md-lexer --bin lexer -- ../samples/index.mdx
//!     cargo run -p duck-md-lexer --bin lexer                       # loops over ../samples/errors/
//!     echo '`oops' | cargo run -p duck-md-lexer --bin lexer        # stdin
//!
//! Flags:
